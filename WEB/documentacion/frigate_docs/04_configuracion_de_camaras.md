# Configuración de Cámaras y RTSP

*Documentación Técnica Oficial Benthic Core — Módulo 4*
*Fuente Original:* [https://docs.frigate.video/frigate/camera_setup](https://docs.frigate.video/frigate/camera_setup)

> **Navegación Rápida:** ◀️ **Anterior:** [Instalación y Despliegue con Docker](./03_instalacion_y_despliegue.md) | ➡️ **Siguiente:** [Pipeline de Video e Inteligencia Artificial](./05_pipeline_de_video_e_ia.md)
...
![Imagen](/assets/images/resolutions-min-ebb4aa1e70f55947c8013c3ab8978201.jpg)
...
* I Frame Interval: 5
[Edit this page](https://github.com/blakeblackshear/frigate/edit/master/docs/docs/frigate/camera_setup.md)
...
| :--- | ---: |
| ◀️ **Anterior:** [Instalación y Despliegue con Docker](./03_instalacion_y_despliegue.md) | ➡️ **Siguiente:** [Pipeline de Video e Inteligencia Artificial](./05_pipeline_de_video_e_ia.md) |
